...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "INTRADAY_UNKNOWN_MARKET_POLICY": {
        "title": "Intraday Unknown Market Policy",
        "description": "How to handle stocks with unrecognized market codes. 'skip' = skip them (default, fail-closed); 'cn_compat' = treat as A-share (old behavior).",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "skip",
        "options": ["skip", "cn_compat"],
        "validation": {},
        "display_order": 72,
        "help_key": "settings.system.INTRADAY_UNKNOWN_MARKET_POLICY",
        "examples": [
    ...
    "INTRADAY_CALENDAR_FAIL_OPEN": {
        "title": "Intraday Calendar Fail-Open",
        "description": "When exchange calendar is unavailable, continue intraday tasks as if market is open (fail-open) or skip them (fail-closed, default).",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "toggle",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 73,
        "help_key": "settings.system.INTRADAY_CALENDAR_FAIL_OPEN",
        "examples": [
    ...
    "INTRADAY_LEGACY_FALLBACK_ENABLED": {
        "title": "Intraday Legacy Fallback",
        "description": "Fall back to old records (no analysis_phase/effective_trading_date) when primary query misses. Default off to avoid masking primary-path issues.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "toggle",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 74,
        "help_key": "settings.system.INTRADAY_LEGACY_FALLBACK_ENABLED",
        "examples": [
    ...
    "INTRADAY_RESET_ON_START": {
        "title": "Intraday Reset On Start",
        "description": "Force-clear today's intraday events on startup (--reset-intraday-events). Default false so restarts preserve events.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "toggle",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 75,
        "help_key": "settings.system.INTRADAY_RESET_ON_START",
        "examples": [
    ...
    "INTRADAY_FORCE_RUN": {
        "title": "Intraday Force Run",
        "description": "Skip trading-day and calendar checks for intraday tasks. Use for testing or non-standard schedules.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "toggle",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 76,
        "help_key": "settings.system.INTRADAY_FORCE_RUN",
        "examples": [
